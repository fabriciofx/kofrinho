...
- Name: 02-login.spec.ts >> Login Flow >> should clear login on logout
- Location: e2e/02-login.spec.ts:76:3
...
Locator: locator('text=Bem-vindo, Test User 1780232467898')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Bem-vindo, Test User 1780232467898')
...
- complementary:
  ...
  - paragraph: Test User 1780232467898
  - paragraph: test-1780232467898@example.com
  - text: Sem foto
  - button "Alterar foto"
- main:
