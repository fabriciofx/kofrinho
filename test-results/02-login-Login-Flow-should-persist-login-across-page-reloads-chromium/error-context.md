...
- Location: e2e/02-login.spec.ts:56:3
...
Locator: locator('text=Bem-vindo, Test User 1780232467702')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Bem-vindo, Test User 1780232467702')
...
- complementary:
  ...
  - paragraph: Test User 1780232467702
  - paragraph: test-1780232467702@example.com
  - text: Sem foto
  - button "Alterar foto"
- main:
